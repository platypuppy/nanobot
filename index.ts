...
const { grocheCentral, grocheBots, grocheGaming, comfyposting, worstImagesEver, music, originalContent } = require('./groche-channels.json');
import { stars_initialize, stars_onStarAdded } from './moron/stars';
import { chatty_onMessageSend } from './moron/chatty';
...
const client = new Client({
	...
	presence: {
		activities: [
			{ name: 'your mom', type: ActivityType.Competing },
		],
		status: 'dnd',
	},
	partials: [
